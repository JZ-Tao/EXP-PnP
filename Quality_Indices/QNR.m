...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [QNR_index,D_lambda_index,D_s_index] = QNR(I_F,I_MS,I_MS_LR,I_PAN,sensorInf,ratio,S,p,q,alpha,beta)

if nargin < 10+1, beta=1; end
if nargin < 9+1, alpha=1; end
if nargin < 8+1, q=1; end
if nargin < 7+1, p=1; end
if nargin < 6+1, S=32; end

D_lambda_index = D_lambda(I_F,I_MS,S,p);

D_s_index = D_s(I_F,I_MS,I_MS_LR,I_PAN,sensorInf,ratio,S,q);
