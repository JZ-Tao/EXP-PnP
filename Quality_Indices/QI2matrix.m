...
if is_FS
    ...
    QI_matrix{1,col} = 'NIQE';col = col+1;
else
...
if is_FS
    for i = 1:k
        ...
        QI_matrix{i+1,col} = QI_{i}.D_lambda_F; col = col+1;
        QI_matrix{i+1,col} = QI_{i}.D_S_Q; col = col+1;
        QI_matrix{i+1,col} = QI_{i}.D_S_R; col = col+1;
        QI_matrix{i+1,col} = QI_{i}.HQNR; col = col+1;
        QI_matrix{i+1,col} = QI_{i}.RQNR; col = col+1;
        QI_matrix{i+1,col} = QI_{i}.NIQE; col = col+1;
