...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [I_Filtered, h] = MTF_PAN(I_PAN,sensorInf,ratio)
if ~isfield(sensorInf, 'sensor')
    sensor = sensorInf;
else
    sensor = sensorInf.sensor;
end
if ~isfield(sensorInf, 'MTF_offset')
    MTF_offset = 0;
else
    MTF_offset = sensorInf.MTF_offset;
end
switch sensor
    case 'QB' 
        GNyq = 0.15; 
